...
<html>
    <head>
        ...
        <title>Aplikasi Penilaian Siswa SMP</title>
    ...
    <body>
            ...
            <div class="profile-sidebar">
                <div class="profile-userpic">
                    ...
                    if ($this->session->userdata('level') == 1) {
                        echo "<img src=" . base_url() . "uploads/admin/DSC_0555-1.jpg class='img-responsive' alt=''>";
                    ...
                    <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                        <div class="panel panel-orange panel-widget border-right">
                            <div class="row no-padding"><em class="fa fa-xl fa-users color-teal"></em>
                                <?php
                                $jumlah1 = $this->db->query("SELECT count(*) as jumlah_data1 FROM siswa")->result();
                                foreach ($jumlah1 as $jow1) {

                                    echo "<div class='large'>$jow1->jumlah_data1</div>";
                                }
                                ?>
        ...
        <div class="col-sm-12">
            <p class="back-link">Copyright &copy; <a href="https://www.Tutorkomputer.com">Fitria Afwiyatin Nihayah</a></p>
        </div>
    </div><!--/.row-->
</div>	<!--/.main-->
