...
?>
<br>
<h4><center>BOBOT PELANGGARAN</center></h4> 
<br>
<button type="button" class="btn btn-primary btn-md pull-right" data-toggle="modal" data-target="#exampleModal">   Tambah Bobot
</button>
